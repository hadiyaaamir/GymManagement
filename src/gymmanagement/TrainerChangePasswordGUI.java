 ...
 * @author PC
 */
public class TrainerChangePasswordGUI extends javax.swing.JFrame {
    ...
    public TrainerChangePasswordGUI() {
        initComponents();
    ...
    private void initComponents() {
        ...
        conpass.setBounds(380, 284, 170, 30);
        ...
        oldpass.setBounds(340, 170, 210, 30);
    ...
    boolean checkPass() {
        ...
        try {
            ...
            String sql = "select password from Trainer where TrainerID = '" + LoginGUI.trainerid + "';";
            ...
            Logger.getLogger(TrainerChangePasswordGUI.class.getName()).log(Level.SEVERE, null, ex);
        }
        return false;
    }
    ...
    private void nextBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nextBtnActionPerformed
        ...
        if (isEmpty) {
            ...
            m.updateTrainer("password", newp, LoginGUI.trainerid);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TrainerChangePasswordGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
