 ...
 * @author PC
 */
public class DeletePopupTrainer extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gymmanagement/sure delete.PNG"))); // NOI18N
    ...
    private void deleteBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteBtnActionPerformed
        ...
        try {
            ...
            String sql = "DELETE FROM `trainerbank`"
                    + "WHERE IBAN = '" + card + "';";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeletePopupTrainer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
