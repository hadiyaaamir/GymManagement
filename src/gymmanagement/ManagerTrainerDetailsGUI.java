 ...
 * @author PC
 */
public class ManagerTrainerDetailsGUI extends javax.swing.JFrame {
    ...
    public ManagerTrainerDetailsGUI() {
        initComponents();
    ...
    private void initComponents() {
        ...
        MyClients.setText("Current Trainers");
        ...
        MyClients.setBounds(70, 167, 130, 20);
        ...
        header1.setForeground(new java.awt.Color(56, 85, 98));
        header1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gymmanagement/team header.PNG"))); // NOI18N
        getContentPane().add(header1);
        header1.setBounds(67, 190, 640, 30);
        ...
        jScrollPane2.setBounds(70, 190, 640, 210);

        buttons.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        buttons.setForeground(new java.awt.Color(56, 85, 98));
        buttons.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gymmanagement/manager buttons.PNG"))); // NOI18N
        getContentPane().add(buttons);
        buttons.setBounds(160, 420, 490, 50);
        ...
        background.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gymmanagement/mANAGER TRAINERS.PNG"))); // NOI18N
        ...
        viewBtn.setBounds(500, 420, 130, 50);
    ...
    private void fireBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_fireBtnActionPerformed
        ...
        if (selectedIndex == -1) {
            ...
            selectError.setVisible(false);
            trid = model.getValueAt(selectedIndex, 0).toString();
            new FirePopup().setVisible(true);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ManagerTrainerDetailsGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
