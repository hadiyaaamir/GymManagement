 ...
 * @author PC
 */
public class ManagerLogbookGUI extends javax.swing.JFrame {
    ...
    public ManagerLogbookGUI() {
     ...
     void updateTable() {
        ...
        try {
            ...
            sql = "SELECT `Date`, `StartTime`, `Endtime` "
                    + "FROM `log`;";
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gymmanagement/log.PNG"))); // NOI18N
        getContentPane().add(jLabel1);
        jLabel1.setBounds(180, 100, 352, 76);
