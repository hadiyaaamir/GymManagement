 ...
 * @author PC
 */
public class ManagerMemberDetailsGUI extends javax.swing.JFrame {
    ...
    public ManagerMemberDetailsGUI() {
        initComponents();
    ...
    private void initComponents() {
        ...
        MyClients.setText("Active Members");
   ...
   memberhover.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ManagerMemberDetailsGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
