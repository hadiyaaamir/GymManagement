 ...
 * @author PC
 */
public class AboutUsTrainerGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        background.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gymmanagement/about us trainer.PNG"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AboutUsTrainerGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
