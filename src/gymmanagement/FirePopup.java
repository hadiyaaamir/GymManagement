 ...
 * @author PC
 */
public class FirePopup extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gymmanagement/sure fire.PNG"))); // NOI18N
    ...
    private void deleteBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteBtnActionPerformed
        ...
        String id = ManagerTrainerDetailsGUI.trid;
        
        Methods m = new Methods();
        m.updateTrainer("Active", "0", id);
        updateTable();
        this.setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FirePopup.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
