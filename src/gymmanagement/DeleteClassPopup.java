 ...
 * @author PC
 */
public class DeleteClassPopup extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gymmanagement/sure del class.PNG"))); // NOI18N
        ...
        deleteBtn.setBounds(70, 170, 170, 40);
    ...
    private void deleteBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteBtnActionPerformed
        ...
        try {
            ...
            String sql = "DELETE FROM `bankdetails`"
                    + "WHERE CardNum = '" + card + "';";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeleteClassPopup.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DeleteClassPopup().setVisible(true);
            }
        });
    }
