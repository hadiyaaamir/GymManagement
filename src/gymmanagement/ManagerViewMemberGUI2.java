 ...
 * @author PC
 */
public class ManagerViewMemberGUI2 extends javax.swing.JFrame {
    ...
    void updateHealth() {
        ...
        try {
            ...
            String sql = "SELECT ConditionName FROM `healthconditions` "
                    ...
                    + "WHERE PersonID = '"+ ManagerMemberDetailsGUI.Sid +"');";
    ...
    void setValues() {
        try {
            ...
            Logger.getLogger(ManagerViewMemberGUI2.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ManagerViewMemberGUI2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
