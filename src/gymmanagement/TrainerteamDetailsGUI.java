 ...
 * @author PC
 */
public class TrainerteamDetailsGUI extends javax.swing.JFrame {
...
//            }
    ...
    private void initComponents() {
        ...
        header.setBounds(67, 173, 640, 30);
        ...
        jScrollPane2.setBounds(70, 180, 640, 220);
    ...
    private void viewBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewBtnActionPerformed
        ...
        if (selectedIndex == -1) {
            ...
            MembersTeamGUI.Sid = model.getValueAt(selectedIndex, 0).toString();
            
            new ViewTrainerGUI().setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TrainerteamDetailsGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
