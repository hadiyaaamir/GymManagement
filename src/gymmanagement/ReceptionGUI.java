...
public class ReceptionGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        email.setBounds(300, 260, 220, 30);

        chout.setForeground(new java.awt.Color(56, 85, 98));
        chout.setText("Checked out!");
        getContentPane().add(chout);
        chout.setBounds(440, 450, 80, 14);

        chin.setForeground(new java.awt.Color(56, 85, 98));
        chin.setText("Checked in!");
        getContentPane().add(chin);
        chin.setBounds(270, 450, 80, 14);
        ...
        kuchKharab.setBounds(240, 368, 300, 14);
        ...
        passwor.setBounds(330, 317, 190, 30);
        ...
        aboutHover.setBounds(380, 16, 100, 60);
        ...
        classHover.setBounds(609, 16, 100, 60);
        ...
        teamHover.setBounds(500, 16, 100, 60);

        background.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gymmanagement/reception.PNG"))); // NOI18N
        ...
        checkoutBtn.setBounds(390, 396, 140, 50);

        checkinBtn.setText("jButton1");
        checkinBtn.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                checkinBtnMouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                checkinBtnMouseExited(evt);
            }
        });
        ...
        checkinBtn.setBounds(235, 396, 130, 50);
...
//                            new TrainerPersonalDetailsGUI().setVisible(true);
    ...
    String logID() {
        ...
        try {
            ...
            String sql3 = "select count(*) as row_id from Log";
    ...
    private void checkinBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_checkinBtnActionPerformed
        ...
        if(valid()) {
            try {
                ...
                String sql = "INSERT INTO `log`(`LogID`, `Date`, `StartTime`, "
                        + " `PersonID`) "
                        
                        + "VALUES ('"+ logID() +"',CURDATE(), "
                        + "CURRENT_TIME, '"+ id +"')";
                ...
                Logger.getLogger(ReceptionGUI.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    private void checkinBtnMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_checkinBtnMouseEntered

    }//GEN-LAST:event_checkinBtnMouseEntered

    private void checkinBtnMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_checkinBtnMouseExited

    }//GEN-LAST:event_checkinBtnMouseExited
    ...
    private void checkoutBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_checkoutBtnActionPerformed
        ...
        if(valid()) {
            ...
            try {
                ...
                String sql = "update Log set Endtime = CURRENT_TIME " + 
                    "where PersonID = '" + id + "' and Endtime is null;";
                int rs = myStmt.executeUpdate(sql);
    ...
    private javax.swing.JLabel chout;
